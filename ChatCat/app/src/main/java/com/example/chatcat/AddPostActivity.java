...
public class AddPostActivity extends AppCompatActivity {
    ...
    private void updateWithNoImage(final String title, final String description, final String editPostId) {
    ...
    private void updateWasWithImage(final String title, final String description, final String editPostId) {
        ...
        //post is with image; first delete previous image
    ...
    private void prepareNotification(String pId, String title, String description, String notificationType, String notificationTopic) {
        ...
        String NOTIFICATION_TITLE = title; // e.g. Stefania Frunza added new oist
        String NOTIFICATION_MESSAGE = description; //content of post
        String NOTIFICATION_TYPE = notificationType; // now there are two notification types  - chat & post
    ...
    private void sendPostNotification(JSONObject notificationJo) {
                ...
                })
        {
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put("Authorization", "key=AAAAui1BKJU:APA91bH6O2WDiCfcjmUcUZa-Nb8m1AoqconHXlpmDNcbjg7js13D1wo3DvTJiKUeIunrqfcKnldZkPScc08drn2dlVAJPPwy9PDp85lHY0k4AcMQLb2LBK-vkeJi4b6MXAlMW6iaVcso");
