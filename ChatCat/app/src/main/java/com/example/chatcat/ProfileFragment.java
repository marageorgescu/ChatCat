...
import com.example.chatcat.adapters.AdapterPosts;
        ...
        updatePasswordBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(newPassword.length() < 6) {
                    Toast.makeText(getActivity(), "Password's length must be at least 6 characters", Toast.LENGTH_SHORT).show();
                    return;
                }
                dialog.dismiss();
        ...
        builder.setPositiveButton("Update", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!TextUtils.isEmpty(value)) {
                    ...
                    //if uer edit his name, also change it from hist posts
                    if (key.equals("name")) {
                        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Posts");
                        Query quey = ref.orderByChild("uid").equalTo(uid);
                        quey.addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                for (DataSnapshot ds:dataSnapshot.getChildren()) {
